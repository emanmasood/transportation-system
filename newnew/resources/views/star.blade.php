...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#"><span class="glyphicon glyphicon-log-in"></span> logout
        </a></li>
      </ul>
    </div>
  </div>
  ...
  <div class="row content">
	    <div class="col-sm-2 sidenav">
	     <button class="a"><a href="Driv_Info.html">Drive_Info</a></button>
	      <br>
	      <button class="b"><a href="Pass_Info.html">Pass_Info</a></button>
	      <br>
